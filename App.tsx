        ...
        return (
          <>
            <div className="relative z-10">
              <Header />
              {/* Added overflow-x-hidden to prevent horizontal scroll/wiggle on mobile due to animations */}
              <main className="w-full overflow-x-hidden">
                <section className="min-h-screen flex flex-col items-center justify-center text-center px-4">
                  <div className="max-w-4xl">
                    {/* Updated Font Sizes: Reduced tablet size (text-8xl) to prevent overflow */}
                    <h1 className="text-5xl sm:text-7xl md:text-8xl lg:text-[10rem] font-black-condensed tracking-tighter leading-none section-heading">
